...
![](figures/Which.Compounds.Present.png)
...
WhichCompoundsTableCyc <- AllSamplesPresent(Complete.Dataset, "Cyclonic, Both Size Fractions")
WhichCompoundsTableAntiCyc <- AllSamplesPresent(Complete.Dataset, "Anticyclonic, Both Size Fractions")
