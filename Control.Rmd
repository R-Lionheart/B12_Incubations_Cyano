...
# Clear environment
rm(list = setdiff(ls()[!ls() %in% c("file.pattern", "currentDate")], lsf.str()))
```
...
```{r, include = TRUE}
currentDate <- Sys.Date()
csvFileName <- paste("data_processed/", software.pattern, "_QC_Output_", file.pattern, "_", currentDate, ".csv", sep = "")
