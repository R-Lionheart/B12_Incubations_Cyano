...
#### Comparing QC levels in the Vitamins run: 

![5000 minimum area vs 1500 minimum area cutoff.](figures/QC_Comparison.png)
...
CompleteDataset <- read.csv("data_intermediate/Vitamins_Incubations_CompleteDataset.csv")
...
CompleteDatasetAvg <- read.csv("data_intermediate/Vitamins_Incubations_CompleteDatasetAvg.csv")
...
WhichCompoundsTable <- read.csv("data_intermediate/WhichCompoundsTable.csv")
kable(WhichCompoundsTable, caption = "Compounds with 100% and 0% of Samples Present")
```
...
![All Compounds.](figures/DoCompoundProportionsChange.png)
![Only Betaine and Choline.](figures/DoCompoundProportionsChange_BetaineCholine.png)
---
